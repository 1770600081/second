...
class AlipayPay {
     ...
     * @var String 收款支付宝账号
     */
    public $seller_email = '2033217488@qq.com';

    /**
     * @var String 安全检验码，以数字和字母组成的32位字符
     */
    public $key = 'rbwcctbfa0fy0w09qjtmk33bm0pfxjpx';
     ...
     */
    //异步通知地址
    public $notify_url = 'basic.con/notify.php';
// public $notify_url = 'http://www.phpman.cn/index.php?r=order/notify_call';
    /**
     * @var String 页面跳转同步通知页面路径
     * 需http://格式的完整路径，不能加?id=123这类自定义参数，不能写成http://localhost/
     */
    //同步回调地址
    public $return_url = 'basic.com/index.php?r=pay/return';
